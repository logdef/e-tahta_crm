            ...
            <div class="row">
                <div class="col-xs-12">
                            ...
                            <table id="example2" class="table table-bordered table-hover">
                                ...
                                @foreach($data['lassign'] as $lassign)
                                    <tr id="item-{{$lassign->id}}">
                                        <form action="{{route('lessonspackage.guncelle')}}" method="post">
                                            ...
                                            <td>
                                                @csrf
                                                <input type="text" name="id" id="id" value="{{$lassign->id}}">
                                ...
                                <table id="example2" class="table table-bordered table-hover">
                                    ...
                                    @foreach(Cart::content() as $urun)
                                        <tr>
                                            ...
                                            <td>{{$urun->price}}</td>
                                            <td>
                                                <form action="{{route('lessonspackage.productkaldir',$urun->rowId)}}"
                                                      method="post">
                                                    @csrf
                                                    @method('DELETE')
                    ...
                    @if(count(Cart::content()))
                        ...
                        <div class="box-body">
                            <div align="right">
                                <a href="{{route('lessonspackage.edit',$page_id)}}">
                                    <button class="btn btn-success">Paket Düzenle</button>
                                </a>
                            </div>
                        </div>
                    </div>
                    @else
                        <div class="box-body">
                            <div align="right">
                                <a href="">
                                    <button disabled class="btn btn-success">Paket düzenle</button>
                                </a>
                            </div>
                        </div>
                    @endif
