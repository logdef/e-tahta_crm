    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <li class="active"><a href="{{route('teacher.index')}}"><i class="fa fa-link"></i> <span>Öğretmenler</span></a></li>
                <li class="active"><a href="{{route('lassign.index')}}"><i class="fa fa-link"></i> <span>Derse Öğretmen Atama</span></a></li>
...
{{--                    <li class="treeview">--}}
{{--                    <a href="{{route('studentassign.index')}}"><i class="fa fa-link"></i> <span>öğrenci Ders Atama</span>--}}
{{--                        <span class="pull-right-container">--}}
{{--                <i class="fa fa-angle-left pull-right"></i>--}}
{{--              </span>--}}
{{--                    </a>--}}
{{--                    <ul class="treeview-menu">--}}
{{--                        <li class="active"><a href="{{route('studentlessons.index')}}"><i class="fa fa-link"></i> <span>Ders Paketleri</span></a></li>--}}
